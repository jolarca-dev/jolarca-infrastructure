...
| # | Boundary                     | Rule                                                     |
|---|------------------------------|----------------------------------------------------------|
| 1 | Marketplace ↔ church-platform | No shared infra, state, credentials, or CI. Scope segregation is organizational, enforced technically (separate repos, orgs' IAM, separate networks). |
...
from both scopes' owners; shared modules are forked, not symlinked.
