...
|---|----------|-------|--------|-------|----------|
| **Critical Blockers** | | | | | |
| C1 | Backup | BorgBackup running daily, encrypted, offsite configured | 🟡 Code ready | Infra | `80-backup.yml` + backup role (255 lines); needs hardware |
...
| H8 | Incident | Incident runbook covers top-5 failure modes | ✅ Done | Infra | `docs/incident-runbook.md` (291 lines, 5 procedures) |
| **Medium Blockers** | | | | | |
